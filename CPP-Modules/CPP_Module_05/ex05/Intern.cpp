...
std::string const	Intern::_formName[8] = {
	"shrubbery creation",
	"Shrubbery Creation",
	"robotomy request",
	"Robotomy Request",
...
Intern::functionPtr const	Intern::_form[8] = {
	...
	&Intern::createPresidentialPardonForm,
	&Intern::createMutantPigTerminationForm,
	&Intern::createMutantPigTerminationForm
};
...
Form*	Intern::createMutantPigTerminationForm(std::string const& target) {
